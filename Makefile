...
#
TCC = gcc -m32 -DOS_UNIX=1 -DOS_WIN=0 -DHAVE_USLEEP=1 -I. -I${TOP}/src

# Some standard variables and programs
#
prefix = /Users/jharris/Projects/sqlite_proc/sqlite-2.8.17-proc/install
exec_prefix = ${prefix}
...
LIBOBJ = attach.lo auth.lo btree.lo build.lo copy.lo date.lo \
         ...
         printf.lo proc.lo random.lo refinteg.lo select.lo \
         table.lo tokenize.lo update.lo util.lo vacuum.lo \
         vdbe.lo vdbeaux.lo where.lo trigger.lo
...
proc.lo:	$(TOP)/src/proc.c $(HDR)
	$(LTCOMPILE) -c $(TOP)/src/proc.c

random.lo:	$(TOP)/src/random.c $(HDR)
	$(LTCOMPILE) -c $(TOP)/src/random.c

refinteg.lo:	$(TOP)/src/refinteg.c $(HDR)
	$(LTCOMPILE) -c $(TOP)/src/refinteg.c
